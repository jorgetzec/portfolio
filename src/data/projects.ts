...
export const projects: Project[] = [
  ...
  {
    id: 'cienciakinich',
    title: 'Kinich: Ciencia y Comunidad',
    description: 'Official website of the Kinich community center of the Sociedad Científica de Dzan AC. Science outreach and community engagement platform with bilingual content.',
    category: 'web-development',
    tags: ['React 18', 'TypeScript', 'Vite', 'Tailwind CSS', 'shadcn/ui', 'Radix UI', 'FastAPI', 'PostgreSQL', 'Science Outreach'],
    repo: '',
    demo: 'https://www.cienciakinich.org/',
    status: 'active',
    images: [],
    year: 2024,
    featured: true,
  },
  {
    ...
    category: 'web-development',
    tags: ['React', 'TypeScript', 'Vite', 'Tailwind CSS', 'GitHub Pages', 'Web Design'],
    repo: 'https://github.com/gongoracastillolab/gongoracastillolab.github.io',
    demo: 'https://gongoracastillolab.github.io/',
    status: 'active',
    images: [],
    year: 2026,
    featured: false,
...
Built with R and the WGCNA package. Includes example datasets, R scripts, and RStudio project files for easy setup and reproducibility.`,
  ...
  {
    id: 'banana-nbs-genomewide',
    title: 'Genome-Wide Analysis of the Banana NBS Gene Family and Expression Profiling of the Fusarium Wilt Resistance Gene MamRGA2 in Response to Defense-Related Phytohormones',
    description: 'Genome-wide analysis of NBS disease-resistance genes in banana, characterizing the Foc TR4 resistance gene MamRGA2 and its response to defense-related phytohormones.',
    category: 'publications',
    tags: ['Genomics', 'Plant-Microbe Interactions', 'Fusarium Wilt', 'NBS-LRR', 'Bioinformatics', 'Phytohormones'],
    repo: '',
    demo: 'https://www.mdpi.com/2073-4425/17/6/700',
    status: 'maintained',
    images: [],
    year: 2026,
    featured: true,
    authors: ['Roblero-Aguilar AN', 'Lizama-Uc G', 'Puch-Hau CA', 'Herrera-Valencia VA', 'García-Laynes S', 'Tzec-Interián JA', 'Lizama-Gasca MG', 'Borges-Argaez IC', 'Peraza-Echeverria S'],
    citation: 'Genes, 2026',
    details: `Banana (Musa spp.) production is severely threatened by Fusarium wilt caused by Fusarium oxysporum f. sp. cubense tropical race 4 (Foc TR4), highlighting the need to identify genetic determinants of resistance. We performed a genome-wide analysis of NBS genes in Musa acuminata ssp. malaccensis, including phylogenetic, chromosomal, and microsynteny analyses. A total of 118 NBS genes were identified, including, for the first time in banana, two NBS genes encoding proteins with integrated domains (an ABC transporter and an NF-YA transcription factor). Chromosomal mapping revealed a marked enrichment of NBS genes on chromosome 3, which harbors MamRGA2, an NBS gene associated with resistance to Foc TR4. RT-qPCR analyses showed that MamRGA2 is strongly induced by exogenous methyl jasmonate (MeJA) in the resistant wild genotype but not in a susceptible Cavendish cultivar.`,
  },
  {
    id: 'chlamydomonas-gpd-regulatory',
    title: 'Integrating co-expression network analysis and machine learning to reveal the regulatory landscape of GPD genes in Chlamydomonas reinhardtii under salinity stress',
    description: 'Integrative WGCNA and machine-learning framework revealing the transcriptional regulation of glycerol-3-phosphate dehydrogenase (GPD) genes in Chlamydomonas under salinity stress.',
    category: 'publications',
    tags: ['WGCNA', 'Machine Learning', 'Random Forest', 'Transcriptomics', 'Chlamydomonas', 'Bioinformatics'],
    repo: '',
    demo: 'https://peerj.com/articles/21060/',
    status: 'maintained',
    images: [],
    year: 2026,
    featured: true,
    authors: ['Tzec-Interián JA', 'Peraza-Echeverria S', 'Herrera-Valencia VA', 'Gongora-Castillo EB'],
    citation: 'PeerJ, 2026',
    details: `Glycerol biosynthesis is a key osmoprotective response in Chlamydomonas reinhardtii mediated by glycerol-3-phosphate dehydrogenases (GPDs). Although GPD2 and GPD3 are known to be salt-responsive with high sequence identity and shared metabolic roles, their regulatory mechanisms remained unclear. Weighted Gene Co-expression Network Analysis (WGCNA) was applied to time-course RNA-seq data from C. reinhardtii exposed to salinity stress. GPD2 and GPD3 clustered into distinct co-expression modules with contrasting temporal profiles: GPD2 was associated with early stress responses and co-expressed with bZIP and C2C2-GATA transcription factors, whereas GPD3 was linked to later adaptive responses associated with MYB, SBP, and ALFIN-like transcription factors. Random Forest validation confirmed strong module coherence.`,
  },
  {
