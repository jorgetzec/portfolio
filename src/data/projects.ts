...
Built with R and the WGCNA package. Includes example datasets, R scripts, and RStudio project files for easy setup and reproducibility.`,
  ...
  {
    id: 'avocado-biocontrol',
    title: 'Characterization of plant growth-promoting bacteria associated with avocado trees (Persea americana Miller) as a potential biocontrol agent against Scirtothrips perseae',
    description: 'Study on bacterial isolates from avocado trees that promote plant growth and show potential for biocontrol of the Scirtothrips perseae pest.',
    category: 'publications',
    tags: ['Plant-Microbe Interaction', 'Biocontrol', 'Agriculture', 'Microbiology'],
    repo: '',
    demo: 'https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0231215',
    status: 'maintained',
    images: [],
    year: 2020,
    featured: false,
  ...
  {
    id: 'thiazoles-synthesis',
    title: 'Solvent-free synthesis of 2-amino-4-arylthiazoles under microwave irradiation',
    description: 'Research on a one-pot, solvent-free synthesis method for 2-amino-4-arylthiazoles using microwave irradiation for increased efficiency.',
    category: 'publications',
    tags: ['Organic Chemistry', 'Green Chemistry', 'Synthesis'],
    repo: '',
    demo: 'https://www.sciencedirect.com/science/article/abs/pii/S0040403912008726',
    status: 'maintained',
    images: [],
    year: 2012,
    featured: false,
  },
  {
    ...
    description: 'Comprehensive review exploring how RNA sequencing technologies have advanced the study of gene expression dynamics at both bulk and single-cell levels.',
    category: 'publications',
    tags: ['Bioinformatics', 'Transcriptomics', 'RNA-seq', 'Review'],
    repo: '',
    demo: 'https://onlinelibrary.wiley.com/doi/full/10.1002/qub2.78',
    status: 'maintained',
    images: [],
    year: 2025,
    featured: false,
  },
  {
    ...
    title: 'Scientific Thinking - Sputnik, Traveler\'s Guide. Secondary',
    description: 'Contribution to the Scientific Thinking section of the Sputnik Traveler\'s Guide for secondary education, published by Group KX.',
    category: 'publications',
    tags: ['Education', 'Science Education', 'Book'],
    repo: '',
    status: 'maintained',
    images: [],
    year: 2022,
    featured: false,
    details: `Tzec-Interián JA, Quintal Flores AI, García Mendoza RG, Colli Us S, Uh Echeverría JH, Loría Chunab GM (2022). Scientific Thinking. In Sputnik, Traveler's Guide. Secondary. Group KX.`
  },
];
